...
function browserSyncInit(baseDir, open, port) {
    ...
    var changeProxyRes = function (proxyRes, req, res) {
    ...
    var onProxyRes = function (proxyRes, req, res) {
        ...
        // }
        console.log("req",req)
        // changeProxyRes(proxyRes, req, res)
    }
    ...
    browserSync.init({
        ...
        server: {
            ...
            //使用代理
            middleware: [
                proxyMiddleware(['/eolinker_os'],
                    {onProxyRes: onProxyRes,onProxyReq:onProxyReq,target: 'http://localhost:8080', changeOrigin: true,secure: false})
            ]
        }
    });
}
